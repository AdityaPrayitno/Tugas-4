...
<body>
	...
	<table class="table table-hover table-striped">
		...
		<tbody>
			<?php
				...
				<tr>
					...
					<a href="hapus.php?id_mahasiswa=<?=$data_mahasiswa['id_mahasiswa']?>" onClick="return confirm('Aapakah anda yakin menghapus data ini?')" class="btn btn-danger">Delete</a></td>
				</tr>
				<?php
				}
				?>
     ...
     <a href="tambah_mahasiswa.php" class="btn btn-warning">Tambah Mahasiswa</a>
